...
def create_df_from_merged_osm_vejman(filename: str) -> pd.DataFrame:
    ...
    property_list = ["osm_id", "CPR_VEJNAVN", "HAST_GENEREL_HAST", "KODE_HAST_GENEREL_HAST", "HAST_GAELDENDE_HAST",
                   "VEJSTIKLASSE", "KODE_VEJSTIKLASSE", "VEJTYPESKILTET", "KODE_VEJTYPESKILTET", "HAST_SENEST_RETTET"]
